...
# -*- encoding: utf-8 -*-
# stub: frozen-objects 0.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "frozen-objects"
  s.version = "0.2.0"
  ...
  s.homepage = "http://github.com/martinkozak/frozen-objects"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5"
  s.summary = "Provides some syntactic sugar of implicitly frozen objects and an freezing operator useful for example in class constants."
